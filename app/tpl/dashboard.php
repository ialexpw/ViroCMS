            ...
            <div class="siimple-grid">
                <div class="siimple-grid-row">
                    ...
                    <div class="siimple-grid-col siimple-grid-col--9">
                        ...
                        <?php
                            if(Viro::CheckUpdate()) {
                                echo '<div class="siimple-alert siimple-alert--primary">';
                                echo '<i class="fas fa-info"></i> <b>Information</b> - There is a newer release of ViroCMS, ensure to update when you get a chance!';
                                echo '</div>';
                            }
                        ?>
